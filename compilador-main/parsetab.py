...
_lr_productions = [
  ...
  ('PROGRAMA -> DECLARACOES PRINCIPAL','PROGRAMA',2,'p_PROGRAMA','sintatico.py',13),
  ('PRINCIPAL -> BEGIN COMANDO LISTA_COM END','PRINCIPAL',4,'p_PRINCIPAL','sintatico.py',17),
  ('DECLARACOES -> DEF_CONST DEF_TIPOS DEF_VAR DEF_FUNC','DECLARACOES',4,'p_DECLARACOES','sintatico.py',21),
  ('DEF_CONST -> CONSTANTE DEF_CONST','DEF_CONST',2,'p_DEF_CONST','sintatico.py',27),
  ('DEF_CONST -> empty','DEF_CONST',1,'p_DEF_CONST','sintatico.py',28),
  ('DEF_TIPOS -> TIPO DEF_TIPOS','DEF_TIPOS',2,'p_DEF_TIPOS','sintatico.py',37),
  ('DEF_TIPOS -> empty','DEF_TIPOS',1,'p_DEF_TIPOS','sintatico.py',38),
  ('DEF_VAR -> VARIAVEL DEF_VAR','DEF_VAR',2,'p_DEF_VAR','sintatico.py',47),
  ('DEF_VAR -> empty','DEF_VAR',1,'p_DEF_VAR','sintatico.py',48),
  ('DEF_FUNC -> FUNCAO DEF_FUNC','DEF_FUNC',2,'p_DEF_FUNC','sintatico.py',57),
  ('DEF_FUNC -> empty','DEF_FUNC',1,'p_DEF_FUNC','sintatico.py',58),
  ('CONSTANTE -> CONST ID EQUAL CONST_VALOR SEMICOLON','CONSTANTE',5,'p_CONSTANTE','sintatico.py',68),
  ('CONST_VALOR -> VSTRING','CONST_VALOR',1,'p_CONST_VALOR','sintatico.py',72),
  ('CONST_VALOR -> EXP_MAT','CONST_VALOR',1,'p_CONST_VALOR','sintatico.py',73),
  ('TIPO -> TYPE ID EQUAL TIPO_DADO SEMICOLON','TIPO',5,'p_TIPO','sintatico.py',77),
  ('VARIAVEL -> VAR ID LISTA_ID COLON TIPO_DADO SEMICOLON','VARIAVEL',6,'p_VARIAVEL','sintatico.py',81),
  ('LISTA_ID -> COMMA ID LISTA_ID','LISTA_ID',3,'p_LISTA_ID','sintatico.py',85),
  ('LISTA_ID -> empty','LISTA_ID',1,'p_LISTA_ID','sintatico.py',86),
  ('CAMPOS -> ID COLON TIPO_DADO LISTA_CAMPOS','CAMPOS',4,'p_CAMPOS','sintatico.py',96),
  ('LISTA_CAMPOS -> SEMICOLON CAMPOS LISTA_CAMPOS','LISTA_CAMPOS',3,'p_LISTA_CAMPOS','sintatico.py',100),
  ('LISTA_CAMPOS -> empty','LISTA_CAMPOS',1,'p_LISTA_CAMPOS','sintatico.py',101),
  ('TIPO_DADO -> INTEGER','TIPO_DADO',1,'p_TIPO_DADO','sintatico.py',111),
  ('TIPO_DADO -> REAL','TIPO_DADO',1,'p_TIPO_DADO','sintatico.py',112),
  ('TIPO_DADO -> ARRAY LBRACKETS NUMERO RBRACKETS OF TIPO_DADO','TIPO_DADO',6,'p_TIPO_DADO','sintatico.py',113),
  ('TIPO_DADO -> RECORD CAMPOS END','TIPO_DADO',3,'p_TIPO_DADO','sintatico.py',114),
  ('TIPO_DADO -> ID','TIPO_DADO',1,'p_TIPO_DADO','sintatico.py',115),
  ('FUNCAO -> FUNCTION NOME_FUNCAO BLOCO_FUNCAO','FUNCAO',3,'p_FUNCAO','sintatico.py',127),
  ('NOME_FUNCAO -> ID PARAM_FUNC COLON TIPO_DADO','NOME_FUNCAO',4,'p_NOME_FUNCAO','sintatico.py',131),
  ('PARAM_FUNC -> LPAREN CAMPOS RPAREN','PARAM_FUNC',3,'p_PARAM_FUNC','sintatico.py',135),
  ('PARAM_FUNC -> empty','PARAM_FUNC',1,'p_PARAM_FUNC','sintatico.py',136),
  ('BLOCO_FUNCAO -> DEF_VAR BEGIN COMANDO LISTA_COM END','BLOCO_FUNCAO',5,'p_BLOCO_FUNCAO','sintatico.py',145),
  ('LISTA_COM -> SEMICOLON COMANDO LISTA_COM','LISTA_COM',3,'p_LISTA_COM','sintatico.py',149),
  ('LISTA_COM -> empty','LISTA_COM',1,'p_LISTA_COM','sintatico.py',150),
  ('BLOCO -> BEGIN COMANDO LISTA_COM END','BLOCO',4,'p_BLOCO','sintatico.py',159),
  ('BLOCO -> COMANDO','BLOCO',1,'p_BLOCO','sintatico.py',160),
  ('COMANDO -> ID NOME ASSIGN EXP_MAT','COMANDO',4,'p_COMANDO','sintatico.py',170),
  ('COMANDO -> WHILE EXP_LOGICA BLOCO','COMANDO',3,'p_COMANDO','sintatico.py',171),
  ('COMANDO -> IF EXP_LOGICA THEN BLOCO SIN_ELSE','COMANDO',5,'p_COMANDO','sintatico.py',172),
  ('COMANDO -> WRITE CONST_VALOR','COMANDO',2,'p_COMANDO','sintatico.py',173),
  ('COMANDO -> READ ID NOME','COMANDO',3,'p_COMANDO','sintatico.py',174),
  ('SIN_ELSE -> ELSE BLOCO','SIN_ELSE',2,'p_SIN_ELSE','sintatico.py',187),
  ('SIN_ELSE -> empty','SIN_ELSE',1,'p_SIN_ELSE','sintatico.py',188),
  ('LISTA_PARAM -> PARAMETRO COMMA LISTA_PARAM','LISTA_PARAM',3,'p_LISTA_PARAM','sintatico.py',198),
  ('LISTA_PARAM -> PARAMETRO','LISTA_PARAM',1,'p_LISTA_PARAM','sintatico.py',199),
  ('LISTA_PARAM -> empty','LISTA_PARAM',1,'p_LISTA_PARAM','sintatico.py',200),
  ('EXP_LOGICA -> EXP_MAT OP_LOGICO EXP_LOGICA','EXP_LOGICA',3,'p_EXP_LOGICA','sintatico.py',212),
  ('EXP_LOGICA -> EXP_MAT','EXP_LOGICA',1,'p_EXP_LOGICA','sintatico.py',213),
  ('EXP_MAT -> PARAMETRO OP_MAT EXP_MAT','EXP_MAT',3,'p_EXP_MAT','sintatico.py',223),
  ('EXP_MAT -> PARAMETRO','EXP_MAT',1,'p_EXP_MAT','sintatico.py',224),
  ('PARAMETRO -> ID NOME','PARAMETRO',2,'p_PARAMETRO','sintatico.py',234),
  ('PARAMETRO -> NUMERO','PARAMETRO',1,'p_PARAMETRO','sintatico.py',235),
  ('OP_LOGICO -> GREATER','OP_LOGICO',1,'p_OP_LOGICO','sintatico.py',244),
  ('OP_LOGICO -> LESS','OP_LOGICO',1,'p_OP_LOGICO','sintatico.py',245),
  ('OP_LOGICO -> EQUAL','OP_LOGICO',1,'p_OP_LOGICO','sintatico.py',246),
  ('OP_LOGICO -> EXNOT','OP_LOGICO',1,'p_OP_LOGICO','sintatico.py',247),
  ('OP_MAT -> PLUS','OP_MAT',1,'p_OP_MAT','sintatico.py',254),
  ('OP_MAT -> MINUS','OP_MAT',1,'p_OP_MAT','sintatico.py',255),
  ('OP_MAT -> TIMES','OP_MAT',1,'p_OP_MAT','sintatico.py',256),
  ('OP_MAT -> DIVIDE','OP_MAT',1,'p_OP_MAT','sintatico.py',257),
  ('NOME -> DOT ID NOME','NOME',3,'p_NOME','sintatico.py',261),
  ('NOME -> LBRACKETS PARAMETRO RBRACKETS','NOME',3,'p_NOME','sintatico.py',262),
  ('NOME -> LPAREN LISTA_PARAM RPAREN','NOME',3,'p_NOME','sintatico.py',263),
  ('NOME -> empty','NOME',1,'p_NOME','sintatico.py',264),
  ('empty -> <empty>','empty',0,'p_empty','sintatico.py',273),
]
